...
if __name__ == '__main__':
    ...
    if 'PENALTY' in PROB_NAME:
        RHO = cfg.get('OPTIMIZER','RHO')
        EXP_FOLDER = os.path.join(BASE_FOLDER,'exp',f'r_{THRESHOLD}',f'{PROB_NAME}_{DATASET_NAME}_RHO_{RHO}')
    else:    
        EXP_FOLDER = os.path.join(BASE_FOLDER,'exp',f'r_{THRESHOLD}',f'{PROB_NAME}_{DATASET_NAME}')
