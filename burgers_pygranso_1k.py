...
# # Directly use PyGRANSO to solve problem
...
def directly_use_pygranso(model, user_fn_lambda, u_0=1., max_iters=100):
...
if __name__ == "__main__":
    ...
    user_fn_lambda = lambda model: user_fn(model, sample_points, boundary_points, boundary_usol):
    # f_lambda = lambda model: f(model, sample_points)
    # ci_lambda = lambda model: None
    # ce_lambda = lambda model: l2_penalty(model, boundary_points, boundary_usol=usolb)
